...
async function handler(req, res) {
    ...
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$users$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["loginUser"])(email, password);
    if ('error' in result) {
    ...
    res.setHeader('Set-Cookie', (0, __TURBOPACK__imported__module__$5b$externals$5d2f$cookie__$5b$external$5d$__$28$cookie$2c$__cjs$29$__["serialize"])('bizkit_token', result.token, {
        httpOnly: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__12b3146d._.js.map