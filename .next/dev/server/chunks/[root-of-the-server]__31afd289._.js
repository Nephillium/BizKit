...
async function handler(req, res) {
    ...
    const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$usersStore$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["registerUser"])(email, password, 'user');
    if ('error' in result) {
        return res.status(400).json({
            ok: false,
            error: result.error
    ...
    const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$usersStore$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["generateToken"])(result);
    res.setHeader('Set-Cookie', (0, __TURBOPACK__imported__module__$5b$externals$5d2f$cookie__$5b$external$5d$__$28$cookie$2c$__cjs$29$__["serialize"])('bizkit_token', token, {
        httpOnly: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__31afd289._.js.map