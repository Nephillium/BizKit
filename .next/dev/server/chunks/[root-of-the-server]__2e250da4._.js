...
async function handler(req, res) {
    ...
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$users$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["registerUser"])(email, password);
    if ('error' in result) {
        return res.status(400).json({
            ok: false,
            error: result.error
    ...
    const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$users$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["generateToken"])(result);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2e250da4._.js.map